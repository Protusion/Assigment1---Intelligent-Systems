...
public class Node {
    ...
    // Auxiliar functions
    /**
     * Checks if two nodes are similar (represent the same state). The method overrides the one in the class Object so that it is used by the structures provided by Java, as for example HashSet.
     */
    @Override
    ...
    /**
     * Prints the node in a String. Determines what is printed by System.out.println(node); It is simple because it is the format used by the debugger.
     */
