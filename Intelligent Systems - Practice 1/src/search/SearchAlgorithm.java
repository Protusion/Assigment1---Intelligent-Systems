...
/**
 * This class must be extended by all classes which implement a search algorithm. Descending classes must implement two methods, the one which searches for the path, and the one returning the result.
 */
public abstract class SearchAlgorithm {
    ...
    /**
     * Return the successors of a given node. It is necessary to update information such as actions, costs, etc. This function corresponds to EXPAND seen in class.
     */
