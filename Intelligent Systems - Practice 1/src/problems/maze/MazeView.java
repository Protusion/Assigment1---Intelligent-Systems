    ...
    public void paintComponent(Graphics graphics) {
        ...
        if (currentState != null) {
            ...
            for (Position cheesePosition : mazeProblem.maze.cheesePositions) {
                if (!currentState.cheeseEaten.contains(cheesePosition)) {
